---
title: "parazitCUB"
author: "Ali Mostafa Anwar And Salma Bayoumi"
date: "22/02/2022"
...
source("read.virus.R") #  V
source("QC.cutoff.R")
source("QC.boxplot.R")
source("GC.content.R") #  V
source("GC.boxplot.R") #  V
source("ENc.values.new.R")
source("ENc.values.old.R")
source("dinuc.base.R") #  V
source("dinuc.codon.R") #  V
source("dinuc.syncodon.R") #  V
source("cub.heatmap.r") #  V
source("RSCU.values.R")
source("read.host.R") #  H
source("SiD.value.R") #  V
source("PR2.plot.R") #  V and H
source("PR2.plot.group.r") #  V
source("ENc.GC3plot.R")#  V and H
source("ENc.GC3plot.group.R")#  V 
source("RCDI.values.R")#  V 
source("MILC.values.r") # V and H
source("B.values.r") # V and H
source("E.values.r") # V only and must to specifi a host
source("MCB.values.R")
source("MELP.values.r") # V only and must to specifi a host
source("FOP.values.R") # V only and must to specifi a host
source("CAI.values.R")
source("Neutrality.plot.r")

source("cub.heatmap.r")
source("RSCU.PCA.r")
source("RSCU.Cluster.r")
```
...
fasta.files <- fasta.files[!grepl("Human", fasta.files, fixed = T)] 
...
theHost <- read.host("flu fasta/Human.fasta", sep = "|")
head(theHost,1)
